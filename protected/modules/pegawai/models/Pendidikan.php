 ...
 *
 * The followings are the available columns in table 'pendidikan':
 * @property integer $id
...
class Pendidikan extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('lembaga, jenjang, tahun, pegawai_id', 'required'),
            array('pegawai_id', 'numerical', 'integerOnly' => true),
            array('lembaga, jenjang', 'length', 'max' => 50),
            array('tahun', 'length', 'max' => 20),
            array('file_name', 'length', 'max' => 45),
            array('created, updated', 'safe'),
            array('file', 'file', 'types' => 'jpg', 'allowEmpty' => true),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, lembaga, jenjang, tahun, file_name, created, updated, pegawai_id', 'safe', 'on' => 'search'),
        );
    }
